...
for(i in 1:nvar){
  ...
  univariate.ace.fit <- cfa(univariate.ace.mod, data = data, group = "zygosity", orthogonal = TRUE, std.lv = TRUE, estimator = estimator, missing = "FIML")   
  
  univariate.ade.fit <- cfa(univariate.ade.mod, data = data, group = "zygosity", orthogonal = TRUE, std.lv = TRUE, estimator = estimator, missing = "FIML")   
  
  univariate.ae.fit <- cfa(univariate.ae.mod, data = data, group = "zygosity", orthogonal = TRUE, std.lv = TRUE, estimator = estimator, missing = "FIML")
  
  univariate.de.fit <- cfa(univariate.de.mod, data = data, group = "zygosity", orthogonal = TRUE, std.lv = TRUE, estimator = estimator, missing = "FIML")
  
  univariate.ce.fit <- cfa(univariate.ce.mod, data = data, group = "zygosity", orthogonal = TRUE, std.lv = TRUE, estimator = estimator, missing = "FIML")   
  
  univariate.e.fit <- cfa(univariate.e.mod, data = data, group = "zygosity", orthogonal = TRUE, std.lv = TRUE, estimator = estimator, missing = "FIML")   
   ...
   # funkcija za ekstrakciju parametara univariate
    ...
    comp.sub.sort <- sort(as.matrix(comp.sub), decreasing = FALSE)
    
    comp.sub.sort.2 <- sort(bic2mat, decreasing = FALSE)
